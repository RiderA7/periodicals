        ...
        <ul class="d-flex align-items-center">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow messages">
                    ...
                    <li class="message-item">
                        <a href="#">
                            <img src="../../Per1/assets/img/messages-1.jpg" alt="" class="rounded-circle">
                            <div>
                                <h4>Maria Hudson</h4>
                    ...
                    <li class="message-item">
                        <a href="#">
                            <img src="../../Per1/assets/img/messages-2.jpg" alt="" class="rounded-circle">
                            <div>
                                <h4>Anna Nelson</h4>
                                <p>Velit asperiores et ducimus soluta repudiandae labore officia est ut...</p>
                                <p>6 hrs. ago</p>
                    ...
                    <li class="message-item">
                        <a href="#">
                            <img src="../../Per1/assets/img/messages-3.jpg" alt="" class="rounded-circle">
                            <div>
                                <h4>David Muldon</h4>
                                <p>Velit asperiores et ducimus soluta repudiandae labore officia est ut...</p>
                                <p>8 hrs. ago</p>
            ...
            <li class="nav-item dropdown pe-3">
                ...
                <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                    <img src="../../Per1/assets/img/profile-img.jpg" alt="Profile" class="rounded-circle">
